...
if __name__ == "__main__":
    # argument parse
    parser = argparse.ArgumentParser(description="load image from specified path, predict the bounding box and its class")
    parser.add_argument('path', help="specify the image path")
